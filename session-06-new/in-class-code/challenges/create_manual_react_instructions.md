...
# for who has older version of node
...
**Note:** now we add the .gitignore! [https://github.com/facebook/react/blob/main/.gitignore]
...
if you change the name, you need start 
```bash
npm run name-start
```
